...
| R02 | member(<ins>id</ins>, username **UK** **NN**, full_name **NN**, email **UK** **NN**, password **NN**, bio, profile_image → member_image **NN**, banner_image → member_image **NN**, aura **NN** **DF** 0) |
| R03 | member_follow(<ins>id_follower</ins> → member, <ins>id_followed</ins> → member) |
| R04 | administrator(<ins>id</ins> → member) |
| R05 | news_post(<ins>id</ins>, title **NN**, body, date_time **NN**, aura **NN** **DF** 0, owner → member **NN**) |
...
| R09 | comment(<ins>id</ins>, body **NN**, date_time **NN**, aura **NN** **DF** 0, id_member → member **NN**, id_post → news_post **NN**) |
...
| **Keys** | {id} |
| **Functional Dependencies** | |
| FD0901 | {id}:- {body, date_time, aura, id_member, id_post} |
| **Normal form** | BCNF |
