...
| R07 | post_topic(<ins>id_post</ins> → news_post, <ins>id_topic</ins> → topic ) |
| R08 | comment(<ins>id</ins>, body **NN**, comment_date **NN**, <ins>id_post</ins> → news_post) |
| R09 | reply(<ins>id_comment</ins> → comment, id_parent → comment) |
| R10 | post_image(<ins>id_post</ins> → news_post, <ins>file</ins> **UK** **NN**) |
...
| ---- | ---- |
| **Keys** | {id} |
| FD0801 | {id}:- {body, comment_date, id_post} | 
| **Normal form** | BCNF |
