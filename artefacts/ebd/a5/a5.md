...
| R14 | follow_notification(<ins>id_follower</ins> → member, <ins>id_followed</ins> → member **CK** id_followed <> id_follower, date_time **NN**) |
| R15 | comment_notification(<ins>id_comment</ins> → comment, <ins>id_commenter</ins> → member, date_time **NN**) |
| R16 | reply_notification(<ins>id_reply</ins> → reply, <ins>id_commenter</ins> → member, date_time **NN**) |
...
| **Functional Dependencies** | |
| FD1501 | {id_comment, id_commenter}:- {date_time} |
| **Normal form** | BCNF |
...
| **Functional Dependencies** | |
| FD1601 | {id_reply, id_commenter}:- {date_time} |
| **Normal form** | BCNF |
