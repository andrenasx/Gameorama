...
| R07 | comment(<ins>id</ins>, body **NN**, commentDate **NN**, <ins>id_post</ins> → news_post) |
| R08 | reply(<ins>id_comment</ins> → comment, id_parent → comment) |
| R09 | post_images(<ins>id_post</ins> → news_post, file **UK** **NN**) |
| R10 | post_aura(<ins>id_post</ins> → news_post, <ins>id_voter</ins> → member, upvote **NN**) |                  
| R11 | comment_aura(<ins>id_comment</ins> → Comment, <ins>id_voter</ins> → member, upvote) |
| R12 | follow_notification(<ins>id_follower</ins> → member, <ins>id_followed</ins> → member) |
| R13 | comment_notification(<ins>id_comment</ins> → comment, <ins>id_commenter</ins> → member, body **NN**) |
| R14 | reply_notification(<ins>id_reply</ins> → reply, <ins>id_commenter</ins> → member, body **NN**) |
| R15 | post_report(<ins>id_reporter</ins> → member, <ins>id_post</ins> → news_post, body **NN**) |
| R16 | comment_report(<ins>id_reporter</ins> → member, <ins>id_comment</ins> → comment, body **NN**) |
| R17 | topic_report(<ins>id_reporter</ins> → member, <ins>id_topic</ins> → topic, body **NN**) | 
| R18 | member_report(<ins>id_reporter</ins> → member, <ins>id_reported</ins> → member, body **NN** |
...
| ---- | ---- |
| **Keys** | {id} |
| FD0701 | {id}:- {body, commentDate, id_post} | 
| **Normal form** | BCNF |

| Table R08  (reply)   |    |
| ---- | ---- |
| **Keys** | {id_comment} |
| FD0801 | {id_comment}:- {id_parent} | 
| **Normal form** | BCNF |

| Table R09  (post_images)   |    |
| ---- | ---- |
| **Keys** | {id_post}, {file} |
| FD0901 | {id_post}:- {file} | 
| FD0902 | {file}:- {id_post} | 
...
| FD1001 | {id_post, id_voter}:- {upvote} | 
| **Normal form** | BCNF |

| Table R11  (comment_aura)   |    |
| ---- | ---- |
| **Keys** | {id_comment, id_voter}  |
| FD1101 | {id_comment, id_voter}:- {upvote} | 
| **Normal form** | BCNF |

| Table R12  (follow_notification)   |    |
| ---- | ---- |
| **Keys** | {id_follower, id_followed} |
| **Normal form** | BCNF |

| Table R13  (comment_notification)   |    |
| ---- | ---- |
| **Keys** | {id_comment, id_commenter} |
| FD0701 | {id_comment, id_commenter}:- {body} | 
| **Normal form** | BCNF |

| Table R14  (reply_notification)   |    |
| ---- | ---- |
| **Keys** | {id_reply, id_commenter} |
| FD0701 | {id_reply, id_commenter}:- {body} | 
| **Normal form** | BCNF |

| Table R15  (post_report)   |    |
| ---- | ---- |
| **Keys** | {id_reporter, id_post} |
| FD0701 | {id_reporter, id_post}:- {body} | 
| **Normal form** | BCNF |

| Table R16  (comment_report)   |    |
| ---- | ---- |
| **Keys** | {id_reporter, id_comment} |
| FD0701 | {id_reporter, id_comment}:- {body} | 
| **Normal form** | BCNF |

| Table R17  (topic_report)   |    |
| ---- | ---- |
| **Keys** | {id_reporter, id_topic} |
| FD1601 | {id_reporter, id_topic}:- {body} | 
| **Normal form** | BCNF |

| Table R18  (member_report)   |    |
| ---- | ---- |
| **Keys** | {id_reporter, id_reported} |
| FD1701 | {id_reporter, id_reported}:- {body} | 
| **Normal form** | BCNF |
