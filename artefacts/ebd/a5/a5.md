...
| R05 | news_post(<ins>id</ins>, title **NN**, body, date_time **NN**, aura **NN**, <ins>owner</ins> → member) |
...
| R09 | comment(<ins>id</ins>, body **NN**, date_time **NN**, <ins>id_post</ins> → news_post) |
...
| **Keys** | {id} |
| **Functional Dependencies** | |
| FD0901 | {id}:- {body, date_time, id_post} |
| **Normal form** | BCNF |
