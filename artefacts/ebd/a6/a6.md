...
| **Query**       | DELETE03               |
| --------------- | ---------------------- |
| **Description** | Delete a follow from a member |
| **Frequency**   | hundreds per day       |
...
| **Query**       | DELETE04              |
| --------------- | --------------------- |
| **Description** | Delete a follow from a topic |
| **Frequency**   | tens per day          |
...
CREATE INDEX search_comment_member ON comment USING hash (id_owner);
```
