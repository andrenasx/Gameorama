            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="profiles-container">
                        ...
                        <div class="card mb-3">
                            ...
                            <div class="card-body d-flex justify-content-between">
                                <p class="card-text d-flex align-items-center">
                                    <span class="material-icons-round">person</span> kaka34 followed you!</p>
                                <small>1m ago</small>
                            </div>
                        </div>
                        ...
                        <div class="card mb-3">
                            <div class="card-header d-flex justify-content-end">
                                <button type="button" data-bs-dismiss="modal" id="close-window-button" aria-label="Close"><span class="material-icons-round">close</span></button>
                            </div>
                            <div class="card-body d-flex justify-content-between">
                                <p class="card-text d-flex align-items-center">
                                    <span class="material-icons-round">comment</span> BrotherSena commented on your post
                                </p>
                                <small>4h ago</small>
                            </div>
                        </div>
