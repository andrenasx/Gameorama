...
?>
    <section class = "p-3 p-lg-5 mt-4 col-lg-8 pb-1 container bg-white" id = "topic_page" style = "height:fit-content">
    ...
    <section class = "topic_navigation mt-3 col-lg-8 px-0 container bg-white">
        ...
        <section class="tab-content">
            <div class="tab-pane fade show active" id="pills-posts" role="tabpanel" aria-labelledby="pills-trending-tab">
                <div class="news-card row p-3 mb-3 mx-0 rounded bg-white">
                    ...
                    <div class="col">
                        <h7 class="post-topics">Topics: Gaming Gadgets; League of Legends</h7><br>
