...
?>
        <section class = "p-3 p-lg-5 mt-4 col-lg-7 pb-0 pb-lg-0 container bg-white rounded" style = "height:fit-content">
            <h1 class="h2 fw-bold">Administration Area</h1>
            <hr class="rounded"></hr>
        ...
        <section class="tab-content ">
            ...
            <div class="tab-pane fade show" id="pills-reported-comments" role="tabpanel" aria-labelledby="pills-comments-tab">
                <section class="container bg-white p-2">
            ...
            <div class="tab-pane fade show" id="pills-reported-topics" role="tabpanel" aria-labelledby="pills-topics-tab">
                <section class="container profiles-container p-2">
                    <article class = "rounded border p-4 mb-3 pe-1">
            ...
            <div class="tab-pane fade show" id="pills-reported-users" role="tabpanel" aria-labelledby="pills-users-tab">
                <section class="container profiles-container p-2">
                    <article class = "rounded border p-4 mb-3">
                        <div class="row align-items-center">
