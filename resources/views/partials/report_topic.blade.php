            ...
            <form id="reportForm">
                <div class="modal-body">
                    ...
                    <div class="form-check" >
                        <div>
                            <input class="form-check-input" type="radio" name="exampleRadios" id="exampleRadios1" value="Inapropriate topic name" >
                            <label class="form-check-label" for="exampleRadios1">
                                Inapropriate topic name
                            </label>
                        </div>
                        <div>
                            <input class="form-check-input" type="radio" name="exampleRadios" id="exampleRadios2" value="Not gaming related" >
                            <label class="form-check-label" for="exampleRadios2">
                                Not gaming related  
                            </label>
                        </div>
                        <div>
                            <input class="form-check-input" type="radio" name="exampleRadios" id="exampleRadios3" value="Typo in name" >
