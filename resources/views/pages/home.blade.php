                    ...
                    <div class="tab-pane fade show active" id="pills-feed" role="tabpanel" aria-labelledby="pills-feed-tab">
                        <div class="news-card mb-3 p-4 rounded bg-white">
                            <header class="row news-card-header">
                                ...
                                <div class="col">
                                    <h6 class="post-topics">Topics: <a href="topic">Gaming Gadgets</a>; <a href="topic">Razer</a></h6>
                                    <div class="d-inline">
...
Como não poderia deixar de ser, Viego contará com uma skin própria intitulada Lunar Beast Viego, e irá conceder a sua própria linha de skins, "Ruined", a começar por Shyvana, Draven e Karma.</p>
                        ...
                        <div class="news-card mb-3 p-4 rounded bg-white">
                            <div class="row news-card-header">
                                ...
                                <div class="col">
                                    <h6 class="post-topics">Topics: <a href="topic">Lego Marvel Super Heroes</a></h6>
                                    <div class="d-inline">
                                      <small class="post-user">Posted by <a href="profile">Legalt_of_Rivia</a></small>
                                      <small>6 hours ago</small>
                                    </div>
                                    <h4 class="post-title-smaller">
                                        <a href="post" class="black-a">Rumor: LEGO Marvel Super Heroes a caminho da Switch</a>
                                    </h4>
                                </div>
                            </div>
                            <div class="news-card-body">
                        ...
                        <div class="news-card mb-3 p-4 rounded bg-white">
                            <div class="row news-card-header">
                                ...
                                <div class="col">
                                    <h6 class="post-topics">Topics: <a href="topic">The Last of Us</a>; <a href="topic">The Witcher 3</a></h6>
                                    <div class="d-inline">
                                      <small class="post-user">Posted by <a href="profile">BrotherSena</a></small>
                                      <small>12 hours ago</small>
                                    </div>
                                    <h4 class="post-title-smaller">
                                        <a href="post" class="black-a">The Last of Us 2 ultrapassa The Witcher 3 e é o jogo mais galardoado de sempre</a>
                                    </h4>
                                </div>
                            </div>
                            <div class="news-card-body">
...
Esta informação é avançada pelo site Game Awards, que assinala que The Last of Us 2, o vencedor da categoria de Jogo do Ano do The Game Awards, alcançou um total de 261 prémios (até agora), ultrapassando assim os 260 alcançados pelo título de 2015 da CD Projekt Red.</p>
                        ...
                        <div class="news-card mb-3 p-4 rounded bg-white">
                            <div class="row news-card-header">
                                ...
                                <div class="col">
                                    <h6 class="post-topics">Topics: <a href="topic">GTA Online</a>; <a href="topic">GTA 5</a></h6>
                                    <div class="d-inline">
                                      <small class="post-user">Posted by <a href="profile">WanWan</a></small>
                                      <small>3 days ago</small>
                                    </div>
                                    <h4 class="post-title-smaller">
                                        <a href="post" class="black-a">O maior segredo de GTA 5 foi descoberto!</a>
                                    </h4>
                                </div>
                            </div>
                            <div class="news-card-body">
                    ...
                    <div class="news-card mb-3 p-4 rounded bg-white">
                            <div class="row news-card-header">
                                ...
                                <div class="col">
                                    <h6 class="post-topics">Topics: <a href="topic">Cyberpunk 2077</a></h6>
                                    <div class="d-inline">
                                      <small class="post-user">Posted by <a href="profile">kaka34</a></small>
                                      <small>1 week ago</small>
                                    </div>
                                    <h4 class="post-title-smaller">
                                        <a href="post" class="black-a">Cyberpunk 2077 corrige vulnerabilidade de segurança</a>
                                    </h4>
                                </div>
                            </div>
                            <div class="news-card-body">
                        ...
                        <div class="news-card mb-3 p-4 rounded bg-white">
                            <div class="row news-card-header">
                                ...
                                <div class="col">
                                    <h6 class="post-topics">Topics: <a href="topic">Console Gaming</a>; <a href="topic">Playstation</a></h6>
                                    <div class="d-inline">
                                      <small class="post-user">Posted by <a href="profile">El_Biden</a></small>
                                      <small>3 months ago</small>
                                    </div>
                                    <h4 class="post-title-smaller">
                                        <a href="post" class="black-a">PlayStation 5 chega a Portugal</a>
                                    </h4>
                                </div>
                            </div>
                            <div class="news-card-body">
        ...
        <aside class="col-md-3 d-none d-md-block">
            ...
            <div class="row mb-3 p-3 bg-white rounded">
                <h4 class="aside-title fw-bold px-1">Most Popular Topics</h3>
                    <ol class="ms-2 mb-0">
                        <li class="mb-2">
                            <p class="mb-0 blue-hover text-truncate"><a href="topic">League of Legends</a></p>
                            <p class="mb-0 text-truncate small-grey-text">1,5M Followers</p>
                        </li>
                        <li class="mb-2">
                            <p class="mb-0 blue-hover text-truncate"><a href="topic">CS:GO</a></p>
                            <p class="mb-0 text-truncate small-grey-text">1,2M Followers</p>
                        </li>
                        <li class="mb-2">
                            <p class="mb-0 blue-hover text-truncate"><a href="topic">MMORPG</a></p>
                            <p class="mb-0 text-truncate small-grey-text">1,0M Followers</p>
                        </li>
                        <li class="mb-2">
                            <p class="mb-0 blue-hover text-truncate"><a href="topic">Fortnite</a></p>
                            <p class="mb-0 text-truncate small-grey-text">971k Followers</p>
                        </li>
                        <li class="mb-2">
                            <p class="mb-0 blue-hover text-truncate"><a href="topic">Console Gaming</a></p>
