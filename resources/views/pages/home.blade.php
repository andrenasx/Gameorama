        ...
        <section class="all-news-cards col-md-8">
            <section class="pill-navigation">
                <ul class="nav nav-pills mb-1 bg-white rounded" id="pills-tab" role="tablist">
                    ...
                    @endauth
                    <li class="nav-item col" role="presentation">
                        <button class="nav-link @guest active @endguest w-100" id="pills-trending-tab" data-bs-toggle="pill"
                            data-bs-target="#pills-trending" type="button" role="tab" aria-controls="pills-trending"
                            aria-selected="@auth false @endauth @guest true @endguest">Trending</button>
                    </li>
                    <li class="nav-item col" role="presentation">
                ...
                <div class="tab-content" id="pills-tabContent">
                    ...
                    @endauth
                    <div class="tab-pane fade @guest active show @endguest" id="pills-trending" role="tabpanel" aria-labelledby="pills-trending-tab">
        ...
        <aside class="col-md-3 d-none d-md-block">
            <section id="hall_of_fame" class="row mb-3 p-3 bg-white rounded">
                ...
                <ol class="ms-2 mb-0">
                    ...
                    <li class="mb-2">
                        <p class="mb-0 blue-hover text-truncate"><a href="{{ route('profile', $member->username)}}">{{$member->username}}</a></p>
                ...
                <h4 class="aside-title fw-bold px-1">Most Popular Topics</h4>
                    <ol class="ms-2 mb-0">
                        @foreach ($popular_topics as $poptopic)
                            <li class="mb-2">
                                <p class="mb-0 blue-hover text-truncate"><a href="/topic/{{$poptopic->name}}">{{$poptopic->name}}</a></p>
