                ...
                <div class="bg-white rounded border p-2">
                    <div class="d-flex justify-content-start me-0 p-2">
                        <div class="bg-secondary ">
                            <button type="button" class="border d-flex align-items-center" data-bs-toggle="modal"
                ...
                <section class="container create_post_buttons mb-2 mb-lg-0">
                    <div class="row d-flex justify-content-around">
                        <button type="button" class="col-5 col-md-4 col-lg-3 btn btn-secondary"
                                onclick="window.location.href='mainpage.php'">Cancel
                        </button>
                        <button type="button" class="col-5 col-md-4 col-lg-3 btn btn-primary"
                                onclick="window.location.href='mainpage.php'">Post
                        </button>
                    </div>
                </section>
            </form>
