        ...
        <main class="form-signup">
            <form method = "post" action="{{ route('signup') }}">
                ...
                <div class="form-floating mb-3">
                    <input type="text" id="inputName" name="full_name" value="{{ old('full_name') }}" class="form-control mb-3" placeholder=" " required>
                    <label for="inputName">Name</label>
                </div>
                <div class="form-floating mb-3">
                    <input type="email" id="inputEmail" name="email" value="{{ old('email') }}" class="form-control mb-3" placeholder=" " required>
                    <label for="inputEmail">Email address</label>
                </div>
                <div class="form-floating mb-3">
                    <input type="text" id="inputUsername" name="username" class="form-control mb-3" placeholder=" " required>
                    <label for="inputEmail">Username</label>
                </div>
                <div class="form-floating mb-3">
                    <input type="password" id="inputPassword" name="password" class="form-control mb-3" placeholder=" " required>
